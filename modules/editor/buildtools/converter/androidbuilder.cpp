...
AndroidBuilder::AndroidBuilder() {
    ...
    m_values["${packageDomain}"] = TString("org.thunderengine.") + project->projectName().remove(' ').toLower();
...
void AndroidBuilder::generateProject() {
    ...
    StringList res = {
        "/android/res/mipmap-xxxhdpi/ic_launcher.webp",
        "/android/res/mipmap-xxxhdpi/ic_launcher_round.webp",
        "/android/res/mipmap-xxhdpi/ic_launcher.webp",
        "/android/res/mipmap-xxhdpi/ic_launcher_round.webp",
        "/android/res/mipmap-xhdpi/ic_launcher.webp",
        "/android/res/mipmap-xhdpi/ic_launcher_round.webp"
        "/android/res/mipmap-mdpi/ic_launcher.webp",
        "/android/res/mipmap-mdpi/ic_launcher_round.webp",
        "/android/res/mipmap-anydpi/ic_launcher.webp",
        "/android/res/mipmap-anydpi/ic_launcher_round.webp",
