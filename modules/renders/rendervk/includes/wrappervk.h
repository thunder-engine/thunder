...
public:
    ...
    static VkDescriptorPool createDescriptorPool(const vector<VkDescriptorPoolSize> &poolSize, uint32_t count);
    static VkDescriptorSet createDescriptorSet(const VkDescriptorSetLayout &layout, VkDescriptorPool pool);

    static VkPipelineLayout createPipelineLayout(const vector<VkDescriptorSetLayout> &layouts);
