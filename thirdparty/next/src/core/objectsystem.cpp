...
/*!
    ...
    \sa factoryAdd(), factoryRemove()
*/
Object *ObjectSystem::objectCreate(const String &url, const String &name, Object *parent) {
    PROFILE_FUNCTION();
...
/*!
    \internal
*/
void ObjectSystem::factoryAdd(const String &name, const String &url, const MetaObject *meta) {
    PROFILE_FUNCTION();
    s_Groups[name] = url;
...
/*!
    \internal
*/
void ObjectSystem::factoryRemove(const String &name, const String &url) {
    PROFILE_FUNCTION();
    s_Groups.erase(name);
...
*/
ObjectSystem::FactoryPair *ObjectSystem::metaFactory(const String &url) {
    PROFILE_FUNCTION();
