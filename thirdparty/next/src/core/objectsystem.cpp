...
*/
/*!
    \fn template<typename T> void factoryAdd(const string &group, const MetaObject *meta)
...
*/
/*!
    \fn template<typename T> void factoryRemove(const string &group)
...
*/
/*!
    \fn template<typename T> T *objectCreate(const string &name = string(), Object *parent = 0)
