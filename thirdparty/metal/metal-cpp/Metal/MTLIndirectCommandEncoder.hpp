...
namespace MTL
{
class IndirectRenderCommand : public NS::Referencing<IndirectRenderCommand, NS::Object>
{
public:
...
class IndirectComputeCommand : public NS::Referencing<IndirectComputeCommand, NS::Object>
{
public:
