...
namespace MTL
{
class BlitPassSampleBufferAttachmentDescriptor : public NS::Copying<BlitPassSampleBufferAttachmentDescriptor, NS::Object>
{
public:
...
class BlitPassSampleBufferAttachmentDescriptorArray : public NS::Referencing<BlitPassSampleBufferAttachmentDescriptorArray, NS::Object>
{
public:
...
class BlitPassDescriptor : public NS::Copying<BlitPassDescriptor, NS::Object>
{
public:
