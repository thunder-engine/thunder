...
namespace MTL
{
class Event : public NS::Referencing<Event, NS::Object>
{
public:
...
class SharedEventListener : public NS::Referencing<SharedEventListener, NS::Object>
{
public:
...
class SharedEventHandle : public NS::Referencing<SharedEventHandle, NS::Object>
{
public:
