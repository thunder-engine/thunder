...
namespace MTL
{
class ComputePipelineReflection : public NS::Referencing<ComputePipelineReflection, NS::Object>
{
public:
...
class ComputePipelineDescriptor : public NS::Copying<ComputePipelineDescriptor, NS::Object>
{
public:
...
class ComputePipelineState : public NS::Referencing<ComputePipelineState, NS::Object>
{
public:
    NS::String*                      label() const;
