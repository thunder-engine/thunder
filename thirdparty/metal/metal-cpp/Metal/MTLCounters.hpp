...
class Counter : public NS::Referencing<Counter, NS::Object>
{
public:
    NS::String* name() const;
};

class CounterSet : public NS::Referencing<CounterSet, NS::Object>
{
public:
    NS::String* name() const;
...
class CounterSampleBufferDescriptor : public NS::Copying<CounterSampleBufferDescriptor, NS::Object>
{
public:
...
class CounterSampleBuffer : public NS::Referencing<CounterSampleBuffer, NS::Object>
{
public:
