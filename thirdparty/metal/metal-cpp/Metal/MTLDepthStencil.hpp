...
class StencilDescriptor : public NS::Copying<StencilDescriptor, NS::Object>
{
public:
...
class DepthStencilDescriptor : public NS::Copying<DepthStencilDescriptor, NS::Object>
{
public:
...
class DepthStencilState : public NS::Referencing<DepthStencilState, NS::Object>
{
public:
    NS::String*   label() const;
