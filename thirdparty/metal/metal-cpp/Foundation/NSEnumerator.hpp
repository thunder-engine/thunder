...
class FastEnumeration : public Referencing<FastEnumeration, Object>
{
public:
...
{
    return NS::Object::sendMessage<UInteger>(this, _NS_PRIVATE_SEL(countByEnumeratingWithState_objects_count_), pState, pBuffer, len);
}
...
{
    return NS::Object::sendMessage<_ObjectType*>(this, _NS_PRIVATE_SEL(nextObject));
}
...
{
    return NS::Object::sendMessage<Array*>(this, _NS_PRIVATE_SEL(allObjects));
}
