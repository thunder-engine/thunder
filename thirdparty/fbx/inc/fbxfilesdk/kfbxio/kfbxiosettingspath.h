...
/*!  \file kfbxiosettingspath.h
 */

#ifndef FBXFILESDK_KFBXIO_KFBXIOSETTINGSPATH_H
#define FBXFILESDK_KFBXIO_KFBXIOSETTINGSPATH_H
...
#define KS_FBX                          KString("\\FBX")       // must be upper case
#define KS_PRESETS                      KString("\\Presets")
#define KS_LOG                          KString("\\Logs")
...
#define KS_3DSMAX_DESIGN                KString("\\3dsMaxDesign")
	
#define KS_VERSION                      KString(FBXSDK_VERSION_STRING)
...
#define IOSN_RESAMPLING_RATE			 "ResamplingRate"
...
#define IMP_RESAMPLINGRATE				IMP_ANIMATION"|"IOSN_RESAMPLING_RATE
...
#endif // FBXFILESDK_KFBXIO_KFBXIOSETTINGSPATH_H
