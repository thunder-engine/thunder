...
#ifndef FBXFILESDK_COMPONENTS_KBASELIB_KLIB_T_STR_LINUX_H
#define FBXFILESDK_COMPONENTS_KBASELIB_KLIB_T_STR_LINUX_H
...
#endif // FBXFILESDK_COMPONENTS_KBASELIB_KLIB_T_STR_LINUX_H
